...
/**
 * 
 * TODO wrap vanilla Direction and name something different
...
public enum Direction implements IEnum {
	 ...
	 * @return
	 */
	public static Direction fromFacing(net.minecraft.util.Direction facing) {
		switch (facing) {
	 ...
	 * @return
	 */
	public net.minecraft.util.Direction toFacing() {
		switch(this) {
		...
		case UP: return net.minecraft.util.Direction.UP;
