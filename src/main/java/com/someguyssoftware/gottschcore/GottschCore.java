...
@ModInfo(modid = GottschCore.MODID, name = GottschCore.NAME, version = GottschCore.VERSION, minecraftVersion = "1.16.5", forgeVersion = "36.2.0", updateJsonUrl = "https://raw.githubusercontent.com/gottsch/gottsch-minecraft-GottschCore/1.16.5-master/update.json")
...
public class GottschCore implements IMod {
	...
	public static void addRollingFileAppender(String modName, Object object) {
		...
		Level level = Level.getLevel(GottschCoreConfig.LOGGING.level.get().toUpperCase());
