...
public enum Direction implements IEnum {
	...
	public static List<String> getNames() {
		List<String> names = EnumSet.allOf(Direction.class).stream().map(x -> x.name()).collect(Collectors.toList());
		return names;
	}
	...
	public static List<String> getHorizontalNames() {
		List<String> names = EnumSet.allOf(Direction.class).stream().filter(x -> x.getAlignment() == Alignment.HORIZONTAL).map(x -> x.name()).collect(Collectors.toList());
		return names;
	}
