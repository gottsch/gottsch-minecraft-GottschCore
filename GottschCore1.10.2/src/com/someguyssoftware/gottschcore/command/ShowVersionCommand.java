...
//			modid =args[0];
			...
			if (player != null) {
				player.addChatMessage(new TextComponentString(mod.getName() + " version: " + mod.getVersion()));
				player.addChatMessage(new TextComponentString("Latest released version: " + mod.getModLatestVersion().toString()));
    		}
		}
		catch(Exception e) {
