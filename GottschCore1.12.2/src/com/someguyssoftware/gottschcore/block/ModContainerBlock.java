...
public abstract class ModContainerBlock extends ModBlock implements ITileEntityProvider {
	 ...
	 * @param material
	 */
	public ModContainerBlock(String modID, String name, Material material) {
	 ...
	 * @param mapColor
	 */
	public ModContainerBlock(String modID, String name, Material material, MapColor mapColor) {
