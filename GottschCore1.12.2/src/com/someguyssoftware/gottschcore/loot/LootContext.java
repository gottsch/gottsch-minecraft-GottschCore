	...
	public LootContext(float luckIn, 
	  ...
	  @Nullable
	    ...
	    public int getLootingModifier() {
	        return LootTableManager.getLootingLevel(getLootedEntity(), getKiller(), damageSource);
	    }
	    ...
	    public static class Builder {
	            ...
	            public LootContext build() {
	                return new LootContext(this.luck, this.world, TreasureLootTables.lootTableManager, this.lootedEntity, this.player, this.damageSource);
	            }
	        }
